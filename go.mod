...
require (
	...
	github.com/3box/pipeline-tools/cd/manager/common/aws/utils v0.0.0-20240306023245-19d920c575d7
	github.com/3box/pipeline-tools/cd/manager/common/job v0.0.0-20240306023245-19d920c575d7
